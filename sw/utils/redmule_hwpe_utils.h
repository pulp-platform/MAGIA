/*
 * RedMulE HWPE Utilities
 * 
 * This header contains HWPE-related definitions and functions for RedMulE control
 * using MMIO-based register access.
 */

#ifndef REDMULE_HWPE_UTILS_H
#define REDMULE_HWPE_UTILS_H
