...
/* Smoke test for the heterogeneous mesh: one row per tile flavour,
   see HETERO_TILE_CFGS in hw/mesh/magia_pkg.sv.

     row 0 -> everything    row 1 -> RedMulE
     row 2 -> Spatz         row 3 -> cluster                            */
