...
int main() {
  ...
  if(get_hartid() == SOURCE_HART_ID) {
    ...
    *(volatile int*) (COLLECTIVE_ADDR_OFFSET + L1_BASE + MEM_OFFSET) = (int) BROADCAST_WORD;
    *(volatile int*) (COLLECTIVE_ADDR_OFFSET + L1_BASE + END_OF_TEST_OFFSET) = (int) END_PATTERN;
