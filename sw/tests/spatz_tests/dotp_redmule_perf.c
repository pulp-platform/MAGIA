 ...
 * 
 * RedMule Dot Product Performance Test
 * 
 * Measures cycles for dot product using RedMule HWPE
 * CSV output: profiling/dotp_redmule_N<size>_perf.csv
 * 
 * Compile with: make clean all test=dotp_redmule_perf N_SIZE=<value>
 * Example: make run test=dotp_redmule_perf N_SIZE=512 mesh_dv=0 gui=0
 */
...
#define B_VEC_TRANSP    (L1_BASE + 0x00012000)  // B transposed [N×1] for RedMule
