 ...
 * 
 * Matrix Multiplication Performance Test: RedMule
...
// Memory address for profiling results (in L2)
...
int main(void) {
    ...
    redmule_cfg((unsigned int)A_MAT_BASE, (unsigned int)B_MAT_BASE, (unsigned int)C_MAT_BASE,
                16, 96, 16, (uint8_t)gemm_ops, (uint8_t)Float16, (uint8_t)Float16);
    ...
    // =====================================================
    // Actual measurement: M×N×K matmul
    // =====================================================
