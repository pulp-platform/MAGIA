...
#(
  ...
  parameter int unsigned MEM_DATA_W                       = magia_tile_pkg::MEM_DATA_W,
  parameter int unsigned MEM_ADDR_W                       = magia_tile_pkg::MEM_ADDR_W,
  parameter int unsigned MEM_BYTE_W                       = magia_tile_pkg::MEM_BYTE_W,
  parameter int unsigned MEM_USER_W                       = magia_tile_pkg::MEM_USER_W,
  parameter int unsigned MEM_ID_W                         = magia_tile_pkg::MEM_ID_W,
  parameter hci_size_parameter_t `HCI_SIZE_PARAM(hwpe)    = magia_tile_pkg::HCI_SIZE_HWPE,
  parameter hci_size_parameter_t `HCI_SIZE_PARAM(dma)     = magia_tile_pkg::HCI_SIZE_DMA,
  parameter hci_size_parameter_t `HCI_SIZE_PARAM(core)    = magia_tile_pkg::HCI_SIZE_CORE,
  parameter hci_size_parameter_t `HCI_SIZE_PARAM(mem)     = magia_tile_pkg::HCI_SIZE_MEM
) (
  input logic                                clk_i,
  input logic                                rst_ni,
