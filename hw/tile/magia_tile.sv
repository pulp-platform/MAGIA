...
`endif
  ...
  generate
    for (genvar idx_core = 0; idx_core < magia_tile_pkg::N_CLUSTER_CORES; idx_core++) begin : gen_idx_core
...
/*******************************************************/
  ...
  generate
    for (genvar idx_core = 0; idx_core < magia_tile_pkg::N_CLUSTER_CORES; idx_core++) begin : gen_idx_core_2
